...
def generate_illustration(prompt: str, output_path: str, aspect_ratio: str = "1:1"):
    """
    Calls Google Gemini image generation API using google-genai client.
    ...
    try:
        ...
        for part in result.candidates[0].content.parts:
            if part.inline_data is not None:
                part.inline_data.save(str(output_file))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Brand Illustrator Generation Script (Google Gemini)")
